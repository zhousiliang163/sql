...
--供应商信息变更明细表
select t.*,rowid from t_supplier_changetrace_detail t where t.changecode='20140504111525762440773';
--不良处理
...
select t.*,rowid from t_sys_supplier t where t.gcompanycode='DHEC-09-M0494';
